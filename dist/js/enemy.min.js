...
this.move=function(){var that=this;this.timer=setInterval(function(){var y=that.ele.offsetTop+that.speed;if(y>gameEngine.ele.offsetHeight){clearInterval(that.timer);gameEngine.ele.removeChild(that.ele);delete gameEngine.allEnemy[that.id];}
...
this.boom=function(){clearInterval(this.timer);var that=this;var i=0;var dieTimer=setInterval(function(){if(i>=that.dieImgs.length){clearInterval(dieTimer);gameEngine.ele.removeChild(that.ele);delete gameEngine.allEnemy[that.id];}
